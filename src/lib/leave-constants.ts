...
export const GENERAL_POLICY_RULES: LeavePolicyRule[] = [
    {
        ...
        description: 'การลาพักผ่อนประจำปีต้องยื่นขออนุมัติล่วงหน้าไม่น้อยกว่า 7 วัน และลากิจต้องยื่นขออนุมัติล่วงหน้าไม่น้อยกว่า 1 วัน โดยต้องได้รับอนุมัติก่อนจึงจะลาหยุดได้',
        icon: '✅',
    },
    {
        id: 'comp-days-policy',

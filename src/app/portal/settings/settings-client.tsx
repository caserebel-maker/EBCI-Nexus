        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-2xl mx-auto">
            ...
            <section style={glass} className="p-6">
                ...
                <p className="text-sm leading-relaxed text-white/70">
                    ตามนโยบายความปลอดภัยของระบบองค์กร การเปลี่ยนรหัสผ่านจำเป็นต้องผ่านกระบวนการตรวจสอบความถูกต้องของบัญชีโดยระบบความปลอดภัยอัตโนมัติ (ใช้เวลาประมาณ 1–2 ชั่วโมง)
                </p>
                ...
                <div className="mt-4 flex gap-3 rounded-xl border border-amber-300/20 bg-amber-300/10 p-4">
                    ...
                    <p className="text-sm leading-relaxed text-white/75">
                        เมื่อผ่านการตรวจสอบความปลอดภัยเรียบร้อยแล้ว ลิงก์สำหรับตั้งรหัสผ่านใหม่จะถูกจัดส่งไปยังอีเมลของบัญชีโดยตรง
                    </p>
                </div>

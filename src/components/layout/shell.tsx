    ...
    return (
        <div className="flex h-screen overflow-hidden bg-brand-gradient bg-fixed dark:bg-background pt-[44px] lg:pt-0 transition-colors duration-300">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-transparent lg:pl-64">
                {/* Top Navbar */}
                <header className="h-[40px] lg:h-16 flex items-center justify-between py-0 lg:py-1 px-3 lg:px-8 border-b border-white/10 dark:bg-card/80 dark:border-border text-white dark:text-foreground">
                    ...
                    >
                        <img
                            src="/sidebar-logo.png"
                            alt="EBCI NEXUS"
                            className="h-8 lg:h-10 drop-shadow-[0_2px_4px_rgba(255,255,255,0.2)] group-active:scale-95 transition-transform"
                        />
                    </Link>

    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                <div className="rounded-lg p-4 border border-emerald-400/40 bg-gradient-to-br from-emerald-600/80 to-emerald-800/80 shadow-lg shadow-emerald-900/30 grid grid-cols-2 items-center gap-2">
                ...
                <div className="rounded-lg p-4 border border-blue-400/40 bg-gradient-to-br from-blue-600/80 to-blue-800/80 shadow-lg shadow-blue-900/30 grid grid-cols-2 items-center gap-2">
                ...
                <div className="rounded-lg p-4 border border-amber-400/40 bg-gradient-to-br from-amber-500/80 to-amber-700/80 shadow-lg shadow-amber-900/30 grid grid-cols-2 items-center gap-2">
